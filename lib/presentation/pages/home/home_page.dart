                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(AppLocalizations.of(context)!.liveAstro,style: TextStyles.sectionTitle,),
                                  Text(AppLocalizations.of(context)!.viewAll,style: TextStyles.sectionSubtitle,)
                                ],
                              ),
                            ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(AppLocalizations.of(context)!.astrologers,style: TextStyles.sectionTitle,),
                                  Text(AppLocalizations.of(context)!.viewAll,style: TextStyles.sectionSubtitle,)
                                ],
                              ),
                            ),
                ...
                children: [
                  FloatingContainer(
                    ...
                    // title: "Chat With Astrologer",
                      title: Text(AppLocalizations.of(context)!.chatAstro),
                  ...
                  FloatingContainer(
                    ...
                    // title: "Call With Astrologer",
                      title: Text(AppLocalizations.of(context)!.callAstro),
                      color: AppColor.componentsColor
                  ),
                ],
              ),
